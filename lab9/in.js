...
console.log("hình chữ nhật có chiều dài là 3 chều rộng là 4 thì có chu vi là",
...
console.log("đường kính hình tròn là",
findDiameterOfCircle(2*2));
/**
...
console.log("chu vi hình tròn là",
findCircumferenceOfCircle(3*3.14));
